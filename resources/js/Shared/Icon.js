...
export default ({ name, className }) => {
  ...
  if (name === 'associate') {
    return (
      <AccountBoxOutlinedIcon className={className} />
    )
  }

  if (name === 'subarea') {
    return (
      <CompareArrowsOutlinedIcon className={className} />
    )
  }

  if (name === 'area') {
    return (
      <CameraRearOutlinedIcon className={className} />
    )
  }
  ...
  if (name === 'cash') {
    return (
        <LocalAtmIcon className={className} />
    )
  }

  if (name === 'extra-hour') {
    return (
      <AddAlarmIcon className={className} />
    )
  }

  if (name === 'picking') {
    return (
      <AllInboxIcon className={className} />
    )
  }
  
  if (name === 'teams') {
    return (
        <GroupWorkIcon className={className} />
    )
  }

  if (name === 'sorter') {
    return (
        <ViewQuiltIcon className={className} />
    )
  }
